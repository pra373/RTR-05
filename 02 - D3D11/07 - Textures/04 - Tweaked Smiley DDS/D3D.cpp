...
//#include<D3DX11tex.h> // for d3d11CreateShaderResourceFromFile() in the book.(frank luna) 3D game						programming with DirectX - 11
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(
		WS_EX_APPWINDOW,
		szAppName,
		TEXT("Prathamesh Laxmikant Paropkari            Direct3D   -  Tweaked Smiley"),
...
HRESULT initialize(void)
{
	...
	hr = LoadD3DTexture(L"Smiley.dds", &gpID3D11ShaderResourceView);
...
HRESULT LoadD3DTexture(const wchar_t* textureFileName, ID3D11ShaderResourceView** ppID3D11ShaderResourceView)
{
	...
	/*hr = D3DX11CreateShaderResourceViewFromFile(gpID3D11Device, textureFileName, NULL, NULL, ppID3D11ShaderResourceView, NULL);*/
