...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(
		WS_EX_APPWINDOW,
		szAppName,
		TEXT("Prathamesh Laxmikant Paropkari :  Direct3D - PushPop : Robotic Arm"),
...
void display(void)
{
	...
	translationMatrix = XMMatrixTranslation(0.1f, 0.0f, 3.3f);
	...
	pushMatrix(worldMatrix);
	{
		...
		rotationMatrix = XMMatrixRotationZ(XMConvertToRadians(shoulder));

		translationMatrix = XMMatrixIdentity();

		translationMatrix = XMMatrixTranslation(-0.1f, 0.0f, 0.0f);

		worldMatrix = translationMatrix * rotationMatrix * worldMatrix;
		...
		pushMatrix(worldMatrix);
		{
			...
			scaleMatrix = XMMatrixScaling(0.8f, 0.2f, 1.0f);
			...
			constantBuffer.sphereColor = XMVectorSet(0.8f, 0.6f, 0.4f, 1.0f);
		...
		// Transformation for fore arm ************


		translationMatrix = XMMatrixIdentity();

		translationMatrix = XMMatrixTranslation(0.5f, 0.0f, 0.0f);

		rotationMatrix = XMMatrixIdentity();

		rotationMatrix = XMMatrixRotationZ(XMConvertToRadians(elbow));

		worldMatrix = rotationMatrix * translationMatrix * worldMatrix;

		translationMatrix = XMMatrixIdentity();

		translationMatrix = XMMatrixTranslation(0.3f, 0.0f, 0.0f);
		...
		pushMatrix(worldMatrix);
		{
			...
			scaleMatrix = XMMatrixScaling(0.8, 0.2f, 1.0f);
		...
		// *************** Transformation for wrist ************************
	
		translationMatrix = XMMatrixIdentity();

		translationMatrix = XMMatrixTranslation(0.45f, 0.0f, 0.0f);


		rotationMatrix = XMMatrixIdentity();

		rotationMatrix = XMMatrixRotationZ(XMConvertToRadians(wrist));
		...
		pushMatrix(worldMatrix);
		{
			...
			scaleMatrix = XMMatrixScaling(0.2f, 0.2f, 0.3f);
		...
		// *************** Transformation for middel finger ************************

		translationMatrix = XMMatrixIdentity();

		translationMatrix = XMMatrixTranslation(0.14f, 0.0f, 0.0f);
		...
		translationMatrix = XMMatrixTranslation(0.04f, 0.0f, 0.0f);
		...
		pushMatrix(worldMatrix);
		{
			...
			scaleMatrix = XMMatrixScaling(0.25f, 0.04f, 0.05f);
		...
		translationMatrix = XMMatrixTranslation(-0.02f, 0.06f, 0.0f);
		...
		pushMatrix(worldMatrix);
		{
			...
			scaleMatrix = XMMatrixScaling(0.17f, 0.04f, 0.08f);
		...
		// *************** Transformation for Thumb finger ************************

		translationMatrix = XMMatrixIdentity();

		translationMatrix = XMMatrixTranslation(-0.15f, 0.06f, 0.0f);
		...
		pushMatrix(worldMatrix);
		{
			...
			scaleMatrix = XMMatrixScaling(0.13f, 0.04f, 0.08f);
		...
		translationMatrix = XMMatrixTranslation(0.07f, -0.18f, 0.0f);
		...
		// *************** Transformation for Little finger ************************

		translationMatrix = XMMatrixIdentity();

		translationMatrix = XMMatrixTranslation(-0.08f, -0.05f, 0.0f);
