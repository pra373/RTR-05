...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(
		WS_EX_APPWINDOW,
		szAppName,
		TEXT("Prathamesh Paropkari :  Direct3D - Diffuse Light On Pyramid"),
...
void display(void)
{
	...
	if (bLightingEnable == TRUE)
	{
		...
		//XMStoreFloat3(&constantBuffer.Ld, XMVectorSet(1.0f, 1.0f, 1.0f, 0.0f));

		//XMStoreFloat3(&constantBuffer.Kd, XMVectorSet(0.5f, 0.5f, 0.5f, 0.0f));


		constantBuffer.Ld = XMVectorSet(0.0f, 1.0f, 1.0f, 0.0f);
