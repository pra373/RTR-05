...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(
		WS_EX_APPWINDOW,
		szAppName,
		TEXT("Prathamesh Laxmikant Paropkari            Direct3D   -  Per Vertex Per Pixel Toggeling"),
...
HRESULT initialize(void)
{
	...
	hr = D3DCompile(vertexShaderSourceCode, lstrlenA(vertexShaderSourceCode) + 1, "VS", NULL, D3D_COMPILE_STANDARD_FILE_INCLUDE, "main", "vs_5_0", 0, 0, &pID3DBlob_VertexShaderSourceCode_PerVertex, &pID3DBlob_Error);
	...
	hr = D3DCompile(pixelShaderSourceCode, lstrlenA(pixelShaderSourceCode) + 1, "PS", NULL, D3D_COMPILE_STANDARD_FILE_INCLUDE, "main", "ps_5_0", 0, 0, &pID3DBlob_PixelShaderSourceCode_PerVertex, &pID3DBlob_Error);
...
//**************************************************** Per Pixel Lighting setup starts here *************************************************
	...
	if (FAILED(hr))
	{
		...
		fprintf(gpFile, "Vertex Shader Compiler Error per pixel = %s\n\n", (char*)pID3DBlob_Error->GetBufferPointer());
	...
	else
	{
		...
		fprintf(gpFile, "Vertex Shader Compilation success per pixel !!\n\n");
	...
	if (FAILED(hr))
	{
		...
		fprintf(gpFile, "Vertex Shader Creation for Per Pixel failed\n\n");
	...
	if (FAILED(hr))
	{
		...
		fprintf(gpFile, "Pixel Shader Compiler for PerPixel Error = %s\n\n", (char*)pID3DBlob_Error->GetBufferPointer());
	...
	else
	{
		...
		fprintf(gpFile, "Pixel Shader Compilation for Per Pixel success !!\n\n");
	...
	if (FAILED(hr))
	{
		...
		fprintf(gpFile, "Pixel Shader Creation forPer Pixel failed\n\n");
	...
	else
	{
		...
		fprintf(gpFile, "Pixel Shader Creation for per pixel success !!\n\n");
