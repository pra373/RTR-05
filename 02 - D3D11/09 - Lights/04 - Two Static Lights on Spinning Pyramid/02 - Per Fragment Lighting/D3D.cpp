...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(
		WS_EX_APPWINDOW,
		szAppName,
		TEXT("Prathamesh Laxmikant Paropkari            Direct3D   -  Two Static Lights on moving pyramid per pixel."),
...
void display(void)
{
	...
	rotationMatrix = XMMatrixRotationY(-XMConvertToRadians(rAngle));

	worldMatrix = rotationMatrix * XMMatrixTranslation(0.0f, 0.0f, 4.0f);
