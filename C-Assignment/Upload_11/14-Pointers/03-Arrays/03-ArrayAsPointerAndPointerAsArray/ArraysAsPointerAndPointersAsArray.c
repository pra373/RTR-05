...
int main(void)
{
	...
	// Using array name as pointer i.e : value of xth element of PLP_IARRAY:*(PLP_IARRAY + x) AND address of xth Element of PLP_IARRAY : (PLP_IARRAY + x)

	printf("\n\n");
	printf("Using array name as pointer i.e : value of xth element of PLP_IARRAY : *(PLP_IARRAY + x) AND address of xth Element of PLP_IARRAY : (PLP_IARRAY + x)\n\n");
	...
	// Using pointer as array name i.e : value of xth element of PLP_IARRAY : ptr_iarray[x] AND address of xth Element of PLP_IARRAY : &ptr_iarray[x]

	printf("Using pointer as Array name i.e : value of xth element of PLP_IARRAY : ptr_iarray[x] AND address of xth Element of PLP_IARRAY : &ptr_iarray[x]\n\n");
	printf("Integer Array Elements and their addresses : \n\n");
