...
int main(void)
{
   ...
   // memset((void*)&visualInfo, 0, sizeof(XVisualInfo));   // remove this line for this code
    ...
    XStoreName(display, window, "Prathamesh Paropkari - Multiviewport Assignment");
        ...
        while(XPending(display))
        {
            ...
            switch(event.type)
            {
               ...
               switch(keySym)
               {
                    ...
                    case 0xff9e:
		            case 0x30:
                    glViewport(0.0f, 0.0f, (GLsizei)WIN_WIDTH, (GLsizei)WIN_HEIGHT);
			        draw();
			        break;

                    case 0xff9c:
		            case 0x31:
			        glViewport(0.0f, 0.0f, (GLsizei)(WIN_WIDTH / 2), (GLsizei)(WIN_HEIGHT / 2));
			        draw();
			        break;
			        ...
			        glViewport((GLsizei)(WIN_WIDTH / 2), 0.0f, (GLsizei)(WIN_WIDTH / 2), (GLsizei)(WIN_HEIGHT / 2));
			        draw();
			        break;
		            ...
		            case 0xff96:
		            case 0x34:
			        glViewport(0, (GLsizei)(WIN_HEIGHT / 2), (GLsizei)(WIN_WIDTH / 2), (GLsizei)(WIN_HEIGHT / 2));
			        draw();
			        break;
		            ...
		            case 0xff9a:
		            case 0x39:
			        glViewport((GLsizei)(WIN_WIDTH / 4), (GLsizei)(WIN_HEIGHT / 4), (GLsizei)(WIN_WIDTH / 2), (GLsizei)(WIN_HEIGHT / 2));
			        draw();
			        break;
