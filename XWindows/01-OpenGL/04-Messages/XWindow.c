...
int main(void)
{
    ...
    XStoreName(display, window, "Prathamesh Paropkari - Message Handeling 24Dec2023");
    ...
    while(1)
    {
      ...
      switch(event.type)
      {
          case KeyPress:
               ...
               case MapNotify:
               printf("\n MapNotify event is received.\n");
               break;

               case FocusIn:
               printf("\n FocusIn event is received.\n");
               break;

               case FocusOut:
               printf("\n FocusOut event is received\n");
               break;
               ...
               switch(event.xbutton.button)
               {
                   ...
                   case 3:
                   printf("Right mouse button id clicked\n");
                   break;
                ...
                case DestroyNotify:
                printf("DistroyNotify event is received\n");
                break;
               
               case FocusChangeMask:
               printf("FocusChangeMask event is received\n");
               break;
