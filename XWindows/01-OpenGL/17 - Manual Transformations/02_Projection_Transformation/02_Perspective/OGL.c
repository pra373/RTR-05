...
int main(void)
{
   ...
   // memset((void*)&visualInfo, 0, sizeof(XVisualInfo));   // remove this line for this code
    ...
    XStoreName(display, window, "Prathamesh Paropkari - Manual Perspective Projection Transformation Code");
