...
int main(void)
{
   ...
   // memset((void*)&visualInfo, 0, sizeof(XVisualInfo));   // remove this line for this code
    ...
    XStoreName(display, window, "Prathamesh Paropkari - Basic assignment All Shapes On Graph Paper");
...
void Draw_Circle(void)
{
	...
	glBegin(GL_POINTS);             //circle starts     
...
void Draw_Triangle(void)
{
	...
	glVertex3f(0.0f, 0.5f, 0.0f);    //left line starts
	glVertex3f(-0.5f, -0.5f, 0.0f);  //left line ends
	glVertex3f(-0.5f, -0.5f, 0.0f);  // base line starts
	glVertex3f(0.5f, -0.5f, 0.0f);   //base line ends
	glVertex3f(0.5f, -0.5f, 0.0f);   //right line starts
...
void Draw_Square(void)
{
	...
	glVertex3f(0.5f, 0.5f, 0.0f);    //square right top 
	glVertex3f(-0.5f, 0.5f, 0.0f);   //square left top 
	glVertex3f(-0.5f, 0.5f, 0.0f);   //square left top 
	glVertex3f(-0.5f, -0.5f, 0.0f);   //square left bottom
	glVertex3f(-0.5f, -0.5f, 0.0f);   //square left bottom
	glVertex3f(0.5f, -0.5f, 0.0f);       //square right bottom.
	glVertex3f(0.5f, -0.5f, 0.0f);   //square right bottom.
	glVertex3f(0.5f, 0.5f, 0.0f);    //square right top.
