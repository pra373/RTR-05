...
int main(void)
{
   ...
   // memset((void*)&visualInfo, 0, sizeof(XVisualInfo));   // remove this line for this code
    ...
    XStoreName(display, window, "Prathamesh Paropkari - Basic assignment Triangle On Graph Paper");
...
void draw(void)
{
  ///code
	...
	glVertex3f(0.0f, 1.0f, 0.0f);    //left line starts
	glVertex3f(-1.0f, -1.0f, 0.0f);  //left line ends
	glVertex3f(-1.0f, -1.0f, 0.0f);  // base line starts
	glVertex3f(1.0f, -1.0f, 0.0f);   //base line ends
	glVertex3f(1.0f, -1.0f, 0.0f);   //right line starts
	glVertex3f(0.0f, 1.0f, 0.0f);
	glEnd();
