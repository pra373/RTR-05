...
int main(void)
{
   ...
   // memset((void*)&visualInfo, 0, sizeof(XVisualInfo));   // remove this line for this code
    ...
    XStoreName(display, window, "Prathamesh Paropkari - Dynamic Deathly Hollows");
...
void DrawIncircle(void)
{
	...
	printf("Length of A = %lf, Length of B = %lf, Length of C = %lf\n\n", Length_A, Length_B, Length_C);
	printf( "Semiperimeter = %lf\n\n", Semiperimeter);
	printf( "Area = %lf\n\n", Area);
	printf( "height = %lf\n\n", Height);
	printf( "Inradious = %lf\n\n", Inradious);
	printf( "InCenter X Coordinate = %f\n\n", floor(Incenter_X));
	printf( "InCenter Y Coordinate = %f\n\n", floor(Incenter_Y));
