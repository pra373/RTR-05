...
int main(int argc, char *argv[])
{
	...
	if (result != CL_SUCCESS)
	{
		printf("clCreateBuffer() Failed For Output Input Matrix : %d\n", result);
		cleanup();
		exit(EXIT_FAILURE);
	}
	...
	// set based 4th argument i.e. numAColumns
	...
	// set based 5th argument i.e. numBColumns
	...
	// set based 6th argument i.e. numCColumns
