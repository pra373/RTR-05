...
void draw(void)
{
	...
	glVertex3f(-2.0f, 1.0f, 0.0f);  //left top

	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(-2.0f, -1.0f, 0.0f);  //left bottom

	glTexCoord2f(1.0f, 0.0f);
	glVertex3f(0.0f, -1.0f, 0.0f);  //right bottom

	//second quad

	glTexCoord2f(1.0f, 1.0f);
	glVertex3f(2.41421f, 1.0f, -1.41421f);  //right top
	...
	glTexCoord2f(1.0f, 0.0f);
	glVertex3f(2.41421f, -1.0f, -1.41421f);  //right bottom
...
void uninitialize(void)
{
    ...
    if (smily_Texture)
	{
		glDeleteTextures(1, &smily_Texture);
		smily_Texture = 0;
	}
