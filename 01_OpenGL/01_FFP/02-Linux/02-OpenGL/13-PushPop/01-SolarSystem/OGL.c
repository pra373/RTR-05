...
int main(void)
{
   ...
   // memset((void*)&visualInfo, 0, sizeof(XVisualInfo));   // remove this line for this code
    ...
    XStoreName(display, window, "Prathamesh Paropkari - Solar System");
...
void draw(void)
{
	...
	//Draw the sun
	gluSphere(quadric, 0.75f, 50, 50);   //library function to draw sphere.
	...
	//draw the earth
	gluSphere(quadric, 0.2f, 15, 15);   //library function to draw sphere.


	//transformations for moon
	glRotatef((GLfloat)moon_year, 0.0f, 0.0f, 1.0f);
	glTranslatef(0.5f, 0.0f, 0.0f);
	glRotatef((GLfloat)moon_day, 0.0f, 0.0f, 1.0f);
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glRotatef(90.0f, 0.0f, 0.0f, 1.0f);
	glColor3f(1.0f, 1.0f, 1.0f);
	//draw moon
	gluSphere(quadric, 0.1f, 15, 15);   //library function to draw sphere.
	...
	// We Enabled Depth So No Coordinate In This Code
	//glEnd();
