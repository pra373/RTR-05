...
void display(void)
{
	...
	glVertex3f(-0.2f, 0.3f, 0.0f);   //first line end

	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex3f(-0.2f, 0.3f, 0.0f);   //second line start

	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex3f(-0.4f, 0.0f, 0.0f);   //second line end

	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex3f(-0.4f, 0.0f, 0.0f);   //third line start
