...
void display(void)
{
	...
	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex3f(-0.5f, -0.2f, 0.0f);  //first and second tringle common point
	...
	glVertex3f(-0.5f, 0.2f, 0.0f);   // second and third tringle common point

	glColor3f(0.0f, 0.0f, 1.0f);
	glVertex3f(-0.5f, -0.2f, 0.0f);

	glColor3f(0.0f, 0.0f, 1.0f);
	glVertex3f(-0.2f, -0.2f, 0.0f);  //third and fourth tringle common point

	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex3f(-0.5f, 0.2f, 0.0f);

	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex3f(-0.2f, 0.2f, 0.0f);   //common point between fourth and fifth

	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex3f(-0.2f, -0.2f, 0.0f);

	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex3f(-0.2f, 0.2f, 0.0f);  //common point between fifth and sixth tringle

	glColor3f(0.0f, 0.0f, 1.0f);
	glVertex3f(-0.2f, -0.2f, 0.0f);

	glColor3f(0.0f, 0.0f, 1.0f);
	glVertex3f(0.1f, -0.2f, 0.0f);  //common point between sixth and seventh tringle

	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex3f(-0.2f, 0.2f, 0.0f);

	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex3f(0.1f, 0.2f, 0.0f);  //common point between seventh and eighth tringle

	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex3f(0.1f, -0.2f, 0.0f);

	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex3f(0.4f, -0.2f, 0.0f);  //common point between eighth and ninth tringle

	glColor3f(0.0f, 0.0f, 1.0f);
	glVertex3f(0.1f, 0.2f, 0.0f);

	glColor3f(0.0f, 0.0f, 1.0f);
	glVertex3f(0.4f, 0.2f, 1.0f);   //common point between ninth and tenth tringle

	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex3f(0.4f, -0.2f, 1.0f);

	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex3f(0.7f, -0.2f, 1.0f); //common point between tenth and eleventh tringle
