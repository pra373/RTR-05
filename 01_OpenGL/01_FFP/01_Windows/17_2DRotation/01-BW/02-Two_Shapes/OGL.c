...
GLfloat Tringle_Angle = 0.0f;
GLfloat Rectangle_Angle = 0.0f;
...
void display(void)
{
	...
	glRotatef(Tringle_Angle, 0.0f, 1.0f, 0.0f);
	...
	glRotatef(Rectangle_Angle, 1.0f, 0.0f, 0.0f);
...
void update(void)
{
	...
	Tringle_Angle = Tringle_Angle + 0.2f;

	if (Tringle_Angle >= 360.0f)
	{
		Tringle_Angle = Tringle_Angle - 360.0f;
	}

	Rectangle_Angle = Rectangle_Angle - 0.2f;

	if (Rectangle_Angle <= 0.0f)
	{
		Rectangle_Angle = Rectangle_Angle + 360.0f;
	}
