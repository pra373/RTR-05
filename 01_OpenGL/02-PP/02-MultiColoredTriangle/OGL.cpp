...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) 
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, 
							szAppName,
							TEXT("Prathamesh Laxmikant Paropkari              Multi Colored Triangle (Programmable Pipeline)"),
...
int initialize(void)
{
	...
	//Step 4 : Let OpenGL Compile the vertex shader code
	...
	glCompileShader(fragmentShaderObject);
	 ...
	 //step 8 : Attach both shaders into this program
