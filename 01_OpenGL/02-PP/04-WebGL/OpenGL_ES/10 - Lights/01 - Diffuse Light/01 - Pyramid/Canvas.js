...
var lightDiffuse = new Float32Array([1.0, 0.5, 0.0]);       // white diffuse light
...
function display()
{
    ...
    var rotationMatrix = mat4.create(); // for rotation

    mat4.translate(modelViewMatrix, modelViewMatrix, [0.0, 0.0, -4.5]); // similar behavar for
...
function update()
{
    ...
    {
        angle_Pyramid = angle_Pyramid + 0.005;
    }
    else
    {
        angle_Pyramid = 0.0;
