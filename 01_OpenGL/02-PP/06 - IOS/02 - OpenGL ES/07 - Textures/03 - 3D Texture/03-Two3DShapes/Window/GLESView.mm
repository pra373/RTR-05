...
- (int)initialize
{
    ...
    // **************************** VBO Position And Texcoord For Pyramid *******************
    ...
    stone_Texture = [self loadGLTextureFromImageFile : @"Stone" :@"bmp"];
...
- (void)display
{
    ...
    mat4 modelViewMatrix = vmath::translate(1.5f, 0.0f, -7.0f);
    ...
    translationMatrix = vmath::translate(-1.7f, 0.0f, -6.0f);
