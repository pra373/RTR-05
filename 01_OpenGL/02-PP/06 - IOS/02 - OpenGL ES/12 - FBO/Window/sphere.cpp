...
enum { AMC_ATTRIBUTE_POSITION_SPHERE, AMC_ATTRIBUTE_NORMAL_SPHERE, AMC_ATTRIBUTE_TEXTURE_SPHERE };
...
void mesh::prepareToDraw(void) {
    ...
    glVertexAttribPointer(AMC_ATTRIBUTE_TEXTURE_SPHERE, 2, GL_FLOAT, GL_FALSE, 0, NULL);

    glEnableVertexAttribArray(AMC_ATTRIBUTE_TEXTURE_SPHERE);
