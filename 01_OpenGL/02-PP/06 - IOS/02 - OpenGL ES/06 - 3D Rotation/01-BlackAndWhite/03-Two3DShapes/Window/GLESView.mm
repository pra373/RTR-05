...
- (void)display
{
    ...
    rotationMatrix = vmath::rotate(angle_Pyarmid, 0.0f, 1.0f, 0.0f);
    ...
    modelViewMatrix = vmath::translate(1.7f, 0.0f, -7.0f);
...
- (void)myUpdate
{
    ...
    angle_Pyarmid = angle_Pyarmid - 2.0f;

    if (angle_Pyarmid <= 0.0f)
    {
        angle_Pyarmid = 360.0f;
    }
