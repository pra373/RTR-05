...
GLuint TEXTURE_CHECKER_BOARD = 0;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) 
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, 
							szAppName,
							TEXT("Prathamesh Laxmikant Paropkari       Checker Board Assignment        "),
...
int initialize(void)
{
	...
	// Clear OpenGl Stars
	glClearColor(0.75f, 0.75f, 0.75f, 1.0f); //Blue Color
...
void display(void)
{
	...
	GLfloat square1Position[12];
	GLfloat square2Position[12];
	...
	glBindTexture(GL_TEXTURE_2D, TEXTURE_CHECKER_BOARD);
...
void loadGLTexture(void)
{
	...
	glGenTextures(1, &TEXTURE_CHECKER_BOARD); //generate textures
