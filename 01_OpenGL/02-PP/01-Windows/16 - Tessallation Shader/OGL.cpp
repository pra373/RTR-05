...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) 
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, 
							szAppName,
							TEXT("Prathamesh Laxmikant Paropkari        Tesselation Program"),
...
void display(void)
{
	...
	//display changing number of segments in windows title bar

	TCHAR str[255];

	wsprintf(str, TEXT("Prathamesh Laxmikant Paropkari        Tesselation Program     [Number Of Line Segments = %d] "), uiNumberOfLineSegments);

	SetWindowText(ghwnd, str);

	//tell OpenGL by how may vertices your 1 path is created
