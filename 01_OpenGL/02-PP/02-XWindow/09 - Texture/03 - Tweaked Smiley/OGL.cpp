...
int main(void)
{
    ...
    XStoreName(display, window, "Prathamesh Paropkari - Tweaked Smiley");
...
int initialize(void)
{
  ...
  //vertex shader
	...
	glCompileShader(fragmentShaderObject);
	 ...
	 {
		 fprintf(gpFile, "Loading of uniform texture sampler variable failed !! Exiting now\n");
		 return(-7);
	 }
	...
	TextureSmiley = loadGLTexture("Smiley.bmp");
