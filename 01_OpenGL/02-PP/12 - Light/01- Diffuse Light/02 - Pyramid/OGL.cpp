...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) 
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, 
							szAppName,
							TEXT("Prathamesh Laxmikant Paropkari  :      Diffuse light  (3D Pyramid) : 30 March 2024 "),
...
void display(void)
{
	...
	//transformations
	 ...
	 rotationMatrix1 = vmath::rotate(AnglePyramid, 1.0f, 0.0f, 0.0f);

	 mat4 rotationMatrix2 = mat4::identity();

	 rotationMatrix2 = mat4::identity();

	 rotationMatrix2 = vmath::rotate(AnglePyramid, 0.0f, 1.0f, 0.0f);

	 mat4 rotationMatrix3 = mat4::identity();

	 rotationMatrix3 = mat4::identity();

	 rotationMatrix3 = vmath::rotate(AnglePyramid, 0.0f, 0.0f, 1.0f);
