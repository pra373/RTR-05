...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		ByteBuffer byteBufferColored = ByteBuffer.allocateDirect(cubeColor.length * 4);
		...
		FloatBuffer colorBuffer = byteBufferColored.asFloatBuffer();
	...
	private void display()
	{
		...
		Matrix.rotateM(rotationMatrix, 0, angle_Cube, 1.0f, 1.0f, 1.0f); // Rotate around Y axis
