package com.PLP.rotation3d_twoshapes;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener
{
	...
	private void display()
	{
		...
		Matrix.setRotateM(rotationMatrix, 0, angle_Triangle, 0.0f, 1.0f, 0.0f);
		...
		Matrix.translateM(modelViewMatrix,0, 1.8f, 0.0f, -6.8f);

		Matrix.setRotateM(rotationMatrix, 0, angle_Rectangle, 1.0f, 1.0f, 1.0f);
	...
	private void update()
	{
		...
		angle_Rectangle = angle_Rectangle + 0.5f;
