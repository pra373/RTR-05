...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		if(shaderCompileStatus[0] == GLES32.GL_FALSE)
		{
			...
			if(infoLogLength[0] > 0)
			{
				...
				System.out.println("YYT: Vertex Shader Compilation Error : " + infoLog);
		...
		if(shaderCompileStatus[0] == GLES32.GL_FALSE)
		{
			...
			if(infoLogLength[0] > 0)
			{
				...
				System.out.println("YYT: Fragment Shader Compilation Error : " + infoLog);
		...
		if(programLinkStatus[0] == GLES32.GL_FALSE)
		{
			...
			if(infoLogLength[0] > 0)
			{
				...
				System.out.println("YYT:Shader Program object Compilation Error : " + infoLog);
	...
	private void printGLInfo(GL10 gl)
	{
		...
		System.out.println("YYT: OpenGL-ES Renderer : " + gl.glGetString(GL10.GL_RENDERER));

		System.out.println("YYT: OpenGL-ES version : " + gl.glGetString(GL10.GL_VERSION));

		System.out.println("YYT: OpenGL-ES Shading Launguage Version : " + gl.glGetString(GLES32.GL_SHADING_LANGUAGE_VERSION));
	}
	...
	private void pushMatrix(float[] matrix)
	{
		...
		System.out.println("YYT: Current Matrix Length : " + matrixStack[matrixStackTop]);
