package com.PLP.perspective_cr;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		ByteBuffer byteBuffer_Color = ByteBuffer.allocateDirect(rectangleColor.length * 4);
		...
		colorBuffer.put(rectangleColor);

		//step 5 : rewind the buffer to 0th index

		colorBuffer.position(0);

		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, rectangleColor.length * 4, colorBuffer, GLES32.GL_STATIC_DRAW);
