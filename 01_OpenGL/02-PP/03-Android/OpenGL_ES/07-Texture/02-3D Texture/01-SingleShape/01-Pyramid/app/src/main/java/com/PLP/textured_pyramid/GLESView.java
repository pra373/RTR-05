package com.PLP.textured_pyramid;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		ByteBuffer byteBuffer_T = ByteBuffer.allocateDirect(pyramidTexCoord.length * 4);
		...
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, pyramidTexCoord.length * 4, texCoordBuffer, GLES32.GL_STATIC_DRAW);
