package com.PLP.geometryshader;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		GLES32.glGetShaderiv(geometryShaderObject,GLES32.GL_COMPILE_STATUS,shaderCompileStatus,0);
		...
		if(shaderCompileStatus[0] == GLES32.GL_FALSE)
		{
			...
			if(infoLogLength[0] > 0)
			{
				infoLog = GLES32.glGetShaderInfoLog(geometryShaderObject);

				System.out.println("PLP: geometry Shader Compilation Error : " + infoLog);
