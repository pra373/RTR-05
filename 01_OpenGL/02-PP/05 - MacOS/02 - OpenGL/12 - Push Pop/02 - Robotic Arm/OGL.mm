...
- (void)applicationDidFinishLaunching:(NSNotification *)notification {
  ...
  [window setTitle:@"Prathamesh Paropkari : Robotic Arm"];
...
- (int)initialize {
  ...
  const GLchar *fragmentShaderSourceCode =
      ...
      "void main(void)\n"
      "{\n"
      "FragColor=colorUniform;\n" // vec4 is working as a constructor
                                    // here not as a datatype
      "}";
...
- (void)display {
  ...
  glUseProgram(shaderProgramObject);
    ...
    //transformations for the Shoulder
   ...
   mat4 modelViewMatrix = mat4::identity();
    ...
    translationMatrix = vmath::translate(-4.0f, 0.0f, -22.0f);
    ...
    if(shoulder)
    {
      ...
      [self pushMatrix:modelMatrix];
      {
        ...
        glUniform4f(colorUniform, 0.8f, 0.6f, 0.4f, 1.0);
      ...
      modelMatrix = [self popMatrix];
        ...
        translationMatrix = vmath::translate(3.3f, 0.0f, 0.0f);
        ...
        translationMatrix = vmath::translate(2.05f, 0.0f, 0.0f);
        ...
        translationMatrix = vmath::translate(3.1f, 0.0f, 0.0f);
        ...
        translationMatrix = vmath::translate(1.1f, 0.0f, 0.0f);
        ...
        translationMatrix = vmath::translate(0.41f, 0.5f, 0.0f);
        ...
        translationMatrix = vmath::translate(0.41f, -1.0f, 0.0f);
        ...
        translationMatrix = vmath::translate(-0.8f, 1.1f, 0.0f);
        ...
        translationMatrix = vmath::translate(-0.49f, -1.5f, 0.0f);
