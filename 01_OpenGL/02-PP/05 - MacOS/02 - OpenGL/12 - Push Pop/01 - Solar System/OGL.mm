...
- (void)applicationDidFinishLaunching:(NSNotification *)notification {
  ...
  [window setTitle:@"Prathamesh Paropkari : Solar System"];
...
- (void)display {
  ...
  mat4 modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix; // order of multiplication is not commutativ. i.e mat1 *
                       // mat2 != mat2 * mat1*/
    ...
    viewMatrix = vmath::lookat(vec3(0.0f, 0.0f, 9.0f), vec3(0.0f, 0.0f, 0.0f), vec3(0.0f, 1.0f, 0.0f));
  ...
  //glUniformMatrix4fv(mvpMatrixUniform, 1, GL_FALSE, modelViewProjectionMatrix);
    ...
    {
        modelViewProjectionMatrix = perspectiveProjectionMatrix * viewMatrix * modelMatrix;  //order  is not commutativ. i.e mat1 * mat2 != mat2 * mat1
    ...
    [self pushMatrix:modelMatrix];
    {
        ...
        scaleMatrix = vmath::scale(0.23f, 0.23f, 0.23f);
