...
- (void)applicationDidFinishLaunching:(NSNotification *)notification {
  ...
  [window setTitle:@"Prathamesh Paropkari : Per Vertex Per Fragment Toggle"];
        ...
        if (status == GL_FALSE)
        {
            ...
            if (infoLogLength > 0)
            {
                ...
                if (szInfoLog != NULL)
                {
                    ...
                    fprintf(gpFile, "Fragment shader Per fragment shader compilation error log : %s\n", szInfoLog);
                    free(szInfoLog);
                    szInfoLog = NULL;
        ...
        if (status == GL_FALSE)
        {
            ...
            if (infoLogLength > 0)
            {
                ...
                if (szInfoLog != NULL)
                {
                    ...
                    fprintf(gpFile, "per fragment shader program linking error log : %s\n", szInfoLog);
                    free(szInfoLog);
                    szInfoLog = NULL;
...
- (void)display {
  ...
  // transformations
    ...
    if(bLightingEnable == true && enablePFLighting == true )
    {
   ...
   if(bLightingEnable == true)
   {
       ...
       if(enablePFLighting == true && bLightingEnable == true)
       {
