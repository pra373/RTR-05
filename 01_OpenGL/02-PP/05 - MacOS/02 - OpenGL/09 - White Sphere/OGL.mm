...
- (void)applicationDidFinishLaunching:(NSNotification *)notification {
  ...
  [window setTitle:@"Prathamesh Paropkari: Plain White Sphere"];
...
- (int)initialize {
  ...
  mvpMatrixUniform = glGetUniformLocation(
      shaderProgramObject,
      "uMVPMatrix"); // must be done after linkage of shader program

  makeSphere(sphere, 1.4, 40, 40);
...
- (void)display {
  ...
  mat4 madelViewProjectionMatrix =
      perspectiveProjectionMatrix *
      modelViewMatrix; // order of multiplication is not commutativ. i.e mat1 *
                       // mat2 != mat2 * mat1
