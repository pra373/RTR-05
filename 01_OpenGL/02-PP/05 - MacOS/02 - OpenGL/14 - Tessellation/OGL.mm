...
@implementation AppDelegate
    ...
    -(void)applicationDidFinishLaunching:(NSNotification *)notification
    {
        ...
        [window setTitle:@"Prathamesh Paropkari: Tessellation Assignment"];
...
-(CVReturn)getFrameForTime:(const CVTimeStamp *) outputTime
{
    ...
    -(int)initialize
    {
        ...
        glAttachShader(shaderProgramObject, fragmentShaderObject);
         ...
         mvpMatrixUniform = glGetUniformLocation(shaderProgramObject, "uMVPMatrix");  //must be done after linkage of shader
    ...
    -(void)display
    {
        ...
        NSString *string = [NSString stringWithFormat:@"Prathamesh Paropkari:    Tessellation Assignment             number of line Segments: %u", uiNumberOfLineSegments];
