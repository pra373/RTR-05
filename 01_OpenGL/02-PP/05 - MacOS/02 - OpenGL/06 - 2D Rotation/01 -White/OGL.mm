...
@implementation AppDelegate
    ...
    -(void)applicationDidFinishLaunching:(NSNotification *)notification
    {
        ...
        [window setTitle:@"Prathamesh Paropkari: 2D Rotation (White)"];
...
-(CVReturn)getFrameForTime:(const CVTimeStamp *) outputTime
{
    ...
    -(int)initialize
    {
        ...
        const GLfloat triangleColor[] = { 1.0f,1.0f,1.0f,1.0f,1.0f,1.0f,1.0f,1.0f,1.0f };
    ...
    -(void)myUpdate
    {
        ...
        AngleTriangle = AngleTriangle - 0.4f;

        if (AngleTriangle <= 0.0f)
        {
