...
void update(void)
{
	...
	{
		xLeftBottom = xLeftBottom - 0.0002f;
		yLeftBottom = yLeftBottom - 0.0002f;
	}

	if (xRightBottom < 1.0f && yRightBottom > -1.0f)
	{
		xRightBottom = xRightBottom + 0.0002f;
		yRightBottom = yRightBottom - 0.0002f;
	}

	if (xRightTop < 1.0f && yRightTop < 1.0f)
	{
		xRightTop = xRightTop + 0.0002f;
		yRightTop = yRightTop + 0.0002f;
	}

	if (xLeftTop > -1.0f && yLeftTop < 1.0f)
	{
		xLeftTop = xLeftTop - 0.0002f;
		yLeftTop = yLeftTop + 0.0002f;
	}

	if (quadAngle < 360.0f)
	{
		quadAngle = quadAngle + 0.07f;
	}
