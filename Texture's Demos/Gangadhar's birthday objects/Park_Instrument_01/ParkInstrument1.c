...
{
	//local variable declaration
	float radious1 = 0.075f;
	float radious2 = 0.14f;
	float radious3 = 0.02f;
	float radious4 = 0.07f;
	...
	glBegin(GL_QUADS);                       // middle rectangle
	...
	glBegin(GL_TRIANGLES);                  //tringle above middle rectangle

	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex3f(0.275f, 0.55f, 0.0f);
	...
	glBegin(GL_QUADS);                     // hollow space between middle rectangle
	...
	glLineWidth(1.0f);
	glBegin(GL_LINES);             // curve part of hollw space       
	...
	for (float angle = 0.0f; angle <= 360.0f; angle = angle + 0.1f)
	{
		...
		float x = radious1 * cos((angle * M_PI) / 180.0f) + (0.275f);
		float y = radious1 * sin((angle * M_PI) / 180.0f) + (0.25f);

		if (angle <= 180.0f)
		{
			glColor3f(1.0f, 1.0f, 1.0f);
			glVertex3f(0.275f, 0.25f, 0.0f);
	...
	glBegin(GL_LINES);                 // base of rectangle
	...
	glBegin(GL_LINES);               // inclined line of slide
	...
	glBegin(GL_LINES);               // horizontal line of slide
	...
	glBegin(GL_LINES);             //upper line of bridge
	...
	glBegin(GL_LINES);             // lower line of bridge
	...
	glBegin(GL_LINES);             // first verticle line of bridge
	...
	glBegin(GL_LINES);             // second verticle line of bridge
	...
	glBegin(GL_LINES);             // third verticle line of bridge
	...
	glBegin(GL_LINES);             // fourth verticle line of bridge
	...
	glBegin(GL_LINES);             // fifth verticle line of bridge
	...
	glBegin(GL_LINES);             // right bar of left figure
	...
	glBegin(GL_LINES);             // left bar of left figure
	...
	glBegin(GL_LINES);                   //Upper semicircle of left figure

	for (float angle = 0.0f; angle <= 360.0f; angle = angle + 0.1f)
	{

		//float radianangle = angle * (M_PI * 180.0f);
		float x = radious2 * cos((angle * M_PI) / 180.0f) + (-0.275f);
		float y = radious2 * sin((angle * M_PI) / 180.0f) + (0.5f);

		if (angle <= 180.0f)
		{
			glColor3f(1.0f, 0.8f, 0.0f);
			glVertex3f(-0.275f, 0.5f, 0.0f);
	...
	glBegin(GL_LINES);                   //Upper small circle of left figure

	for (float angle = 0.0f; angle <= 360.0f; angle = angle + 0.1f)
	{

		//float radianangle = angle * (M_PI * 180.0f);
		float x = radious3 * cos((angle * M_PI) / 180.0f) + (-0.273f);
		float y = radious3 * sin((angle * M_PI) / 180.0f) + (0.655f);


		glColor3f(1.0f, 0.0f, 0.0f);
		glVertex3f(-0.273f, 0.655f, 0.0f);
	...
	glBegin(GL_QUADS);                     // lower rectangle second figure
	...
	glBegin(GL_LINES);                   //centre circle of right figure

	for (float angle = 0.0f; angle <= 360.0f; angle = angle + 0.1f)
	{

		//float radianangle = angle * (M_PI * 180.0f);
		float x = radious4 * cos((angle * M_PI) / 180.0f) + (-0.275f);
	...
	glBegin(GL_LINES);                 // left figure slant line 
