...
{
	//local variable declaration
	float radious_holder_upper_part = 0.1f;
	float radious_inner_circle_big = 0.05f;
	float radious_inner_circle_small = 0.03f;
	...
	glBegin(GL_QUADS);               // seesaw holder lower rectangulat base
	...
	glBegin(GL_QUADS);                  // seesaw seat (left side)

	glColor3f(0.2f, 0.4f, 0.1f);
	glVertex3f(-0.5f, 0.09f, 0.0f);

	glColor3f(0.2f, 0.4f, 0.1f);
	glVertex3f(-0.4f, 0.07f, 0.0f);

	glColor3f(0.2f, 0.4f, 0.1f);
	glVertex3f(-0.4f, 0.12f, 0.0f);
	...
	glBegin(GL_QUADS);                  // seesaw seat back rest (left side)
	...
	glBegin(GL_QUADS);                  // seesaw seat (right side)
	...
	glBegin(GL_QUADS);                  // seesaw seat back rest (right side)
	...
	glLineWidth(10.0f);
	glBegin(GL_LINES);                  // seesaw handle right side (Vertical Part)

	glColor3f(0.7f, 0.0f, 0.5f);
	glVertex3f(0.32f, -0.06f, 0.0f);

	glColor3f(0.7f, 0.0f, 0.5f);
	glVertex3f(0.345f, 0.05f, 0.0f);
	...
	glLineWidth(10.0f);
	glBegin(GL_LINES);                  // seesaw handle right side(horizontal part)

	glColor3f(0.7f, 0.0f, 0.5f);
	glVertex3f(0.31f, 0.05f, 0.0f);

	glColor3f(0.7f, 0.0f, 0.5f);
	glVertex3f(0.375f, 0.03f, 0.0f);
	...
	//glLineWidth(10.0f);
	glBegin(GL_LINES);                  // seesaw handle left side (Vertical Part)

	glColor3f(0.7f, 0.0f, 0.5f);
	glVertex3f(-0.31f, 0.05f, 0.0f);

	glColor3f(0.7f, 0.0f, 0.5f);
	glVertex3f(-0.335f, 0.14f, 0.0f);
    ...
    glBegin(GL_LINES);             // see saw holder upper round part     

	for (float angle = 0.0f; angle <= 360.0f; angle = angle + 0.1f)
	{

		//float radianangle = angle * (M_PI * 180.0f);
		float x = radious_holder_upper_part * cos((angle * M_PI) / 180.0f) + (0.0f);
		float y = radious_holder_upper_part * sin((angle * M_PI) / 180.0f) + (0.0f);
	...
	glBegin(GL_LINES);             // see saw holder inner circle (big)     

	for (float angle = 0.0f; angle <= 360.0f; angle = angle + 0.1f)
	{

		//float radianangle = angle * (M_PI * 180.0f);
		float x = radious_inner_circle_big * cos((angle * M_PI) / 180.0f) + (0.0f);
		float y = radious_inner_circle_big * sin((angle * M_PI) / 180.0f) + (0.0f);
	...
	glBegin(GL_LINES);             // see saw holder inner circle (small)     

	for (float angle = 0.0f; angle <= 360.0f; angle = angle + 0.1f)
	{

		//float radianangle = angle * (M_PI * 180.0f);
		float x = radious_inner_circle_small * cos((angle * M_PI) / 180.0f) + (0.0f);
		float y = radious_inner_circle_small * sin((angle * M_PI) / 180.0f) + (0.0f);
