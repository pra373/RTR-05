...
int initialize(void)
{
	...
	glClearColor(1.0f, 1.0f, 1.0f, 1.0f);   // First OpenGL Function After bridging APIS
...
void display(void)
{
	...
	glVertex3f(-0.1f, 0.602f, 0.0f);


	glVertex3f(-0.09f, 0.634f, 0.0f);


	glVertex3f(-0.14f, 0.616f, 0.0f);

	glVertex3f(-0.14f, 0.582f, 0.0f);
